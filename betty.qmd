...
"C:\Users\bkreb\OneDrive\Documents\Dauphine\Data management\women_empowerment\GlobalFindexDatabase2025.csv"
```

```{r}
Empowerment <- vroom("women_inequalities.csv")
Findex <- vroom("C:/Users/bkreb/OneDrive/Documents/Dauphine/Data management/women_empowerment/GlobalFindexDatabase2025.csv")
```
...
result <- merge(Empowerment, Findex, by = "country", all.x = TRUE)
```

```{r}
findex_empowerment |>
  ggplot(aes(x = fiaccount.t.d, y = swpdechigh, label = country)) +
